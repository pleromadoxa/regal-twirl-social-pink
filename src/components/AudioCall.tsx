...
const AudioCall = ({ 
  ...
  return (
    ...
    >
      ...
      {/* Call interface */}
      <div className="text-center text-white space-y-8 relative" style={{ zIndex: 1000000 }}>
        {/* User avatar */}
      ...
      <div className="absolute top-8 left-1/2 transform -translate-x-1/2" style={{ zIndex: 1000000 }}>
