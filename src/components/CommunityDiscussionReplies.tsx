...
import { useCommunityDiscussionReplies } from '@/hooks/useCommunityDiscussionReplies';
...
interface CommunityDiscussionRepliesProps {
  discussionId: string;
}

export const CommunityDiscussionReplies = ({ discussionId }: CommunityDiscussionRepliesProps) => {
  const { replies, loading, createReply, deleteReply } = useCommunityDiscussionReplies(discussionId);
  const { user } = useAuth();
...
export default CommunityDiscussionReplies;