  ...
  return (
    <div className="space-y-6 relative">
      ...
      <div className="flex items-center gap-3 mb-6">
        <div className="flex items-center gap-2 px-4 py-2 glass dark:glass-dark rounded-full">
        ...
        <Badge variant="outline" className="border-purple-200 text-purple-600 dark:border-purple-700 dark:text-purple-400 glass dark:glass-dark">
      ...
      {threadTweets.map((tweet, index) => (
        <div key={index} className="relative pl-4">
          ...
          <div className="glass dark:glass-dark rounded-3xl border-2 border-purple-100 dark:border-purple-800 p-6 shadow-xl hover:shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:border-purple-300 dark:hover:border-purple-600 relative overflow-hidden">
            {/* Background Gradient */}
            ...
            <div className="relative z-10">
              ...
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-2 px-3 py-1 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-full glass dark:glass-dark">
                  ...
                  {index === 0 && (
                    <Badge className="bg-gradient-to-r from-purple-600 to-pink-600 text-white text-xs glass">
                      Thread Start
                    </Badge>
                  )}
                </div>
                ...
                {index > 0 && (
                  <Button
                    ...
                    className="text-purple-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all duration-300 hover:scale-110 hover:rotate-12 rounded-full w-8 h-8 p-0 glass hover:glass-dark"
                  >
                    <X className="w-4 h-4" />
                  </Button>
                )}
              ...
              <div className="relative">
                ...
                <div className="absolute bottom-3 right-3 flex items-center gap-3">
                  ...
                  {/* Progress circle */}
                  <div className="relative w-8 h-8 glass dark:glass-dark rounded-full">
              ...
              <div className="mt-4 w-full h-1 bg-purple-100 dark:bg-purple-800 rounded-full overflow-hidden glass dark:glass-dark">
                <div 
