...
export const useCommunityDiscussionReplies = (discussionId: string) => {
  const [replies, setReplies] = useState<CommunityDiscussionReply[]>([]);
    ...
    try {
      ...
      const { data: repliesData, error } = await supabase
        ...
        .select(`
          ...
          created_at,
          updated_at,
          profiles!community_discussion_replies_user_id_fkey (
            username,
            display_name,
            avatar_url
          )
