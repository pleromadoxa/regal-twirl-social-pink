...
import { Bell, Heart, UserPlus, MessageSquare, Star } from "lucide-react";
        ...
        <div className="flex items-center justify-center h-[calc(100vh-200px)]">
          <div className="text-center">
            ...
            <p className="text-slate-500 dark:text-slate-400 mb-8 max-w-md">
              Get notified when someone likes your posts, follows you, or mentions you in their content.
            </p>
          </div>
        </div>
      </main>
