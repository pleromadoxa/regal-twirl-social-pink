  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-pink-50 to-blue-50 dark:from-slate-900 dark:via-purple-900 dark:to-slate-900 flex relative">
      ...
      <div className={`flex-1 ${isMobile ? 'px-2 pb-20' : 'px-4'}`} style={isMobile ? {} : { marginLeft: '320px', marginRight: '384px' }}>
        <main className={`w-full ${isMobile ? '' : 'border-x border-purple-200 dark:border-purple-800'} bg-white/60 dark:bg-slate-800/60 backdrop-blur-xl mx-auto`}>
          {/* Header */}
          ...
          <div className={isMobile ? 'p-3' : 'p-6'}>
            ...
            <div>
              <h2 className={`${isMobile ? 'text-base' : 'text-xl'} font-bold mb-4 text-slate-900 dark:text-slate-100`}>
              ...
              {loading || isSearching ? (
                ...
                <div className="text-center py-12">
                  <Building className={`${isMobile ? 'w-10 h-10' : 'w-12 h-12'} text-slate-400 mx-auto mb-4`} />
                  <h3 className={`${isMobile ? 'text-base' : 'text-lg'} font-semibold text-slate-600 dark:text-slate-400 mb-2`}>
                    {searchQuery ? 'No accounts found' : 'No professional accounts yet'}
                  </h3>
                  <p className={`text-slate-500 dark:text-slate-500 ${isMobile ? 'text-sm' : ''}`}>
                    ...
                    >
                      <CardHeader className={isMobile ? 'pb-2' : 'pb-3'}>
                        <div className="flex items-start gap-3">
                          <Avatar className={`${isMobile ? 'w-12 h-12' : 'w-14 h-14'} border-2 border-purple-200 group-hover:border-purple-400 transition-colors`}>
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                              <h3 className={`${isMobile ? 'text-sm' : 'font-semibold'} text-slate-900 dark:text-slate-100 truncate group-hover:text-purple-600 transition-colors`}>
                                {page.page_name}
                              </h3>
                              {page.is_verified && (
